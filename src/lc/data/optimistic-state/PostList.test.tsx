...
// ============================================================================
// TESTY KOMPONENTU (wersja na useState).
//
// Zwróć uwagę: testy są IDENTYCZNE jak przy wersji z reducerem.
// To dowód, że RTL testuje ZACHOWANIE, a nie implementację — zmieniłeś
// całe wnętrze komponentu, a testy nie drgnęły.
//
// Różnica jest gdzie indziej: przy reducerze miałeś DODATKOWO 25 unit testów
// na przejścia stanu. Tutaj tej warstwy nie ma — logika siedzi w handlerach,
// więc jedynym sposobem jej sprawdzenia jest RTL.
//
